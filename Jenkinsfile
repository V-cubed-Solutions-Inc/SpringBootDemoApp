...
//                 COVER build steps
            ...
            post {
                ...
                success {
                    ftpPublisher masterNodeName: 'master', alwaysPublishFromMaster: false, continueOnError: false, failOnError: false, paramPublish:[parameterName:''], publishers: [[configName: 'VS2', transfers: [[asciiMode: false, cleanRemote: false, excludes: '', flatten: false, makeEmptyDirs: false, noDefaultExcludes: false, patternSeparator: '[, ]+', remoteDirectory: '${BUILD_NUMBER}_yyyyMMdd', remoteDirectorySDF: false, removePrefix: '', sourceFiles: 'target/*']], usePromotionTimestamp: false, useWorkspaceInPromotion: false, verbose: true]]
                }
            }
        }
