...
//                 COVER build steps
         ...
         stage ('BlazeMeter') {
            steps {
                blazeMeterTest credentialsId:'1451217', serverUrl:'https://a.blazemeter.com', testId: '12473941', notes:'', sessionProperties:'', jtlPath:'', junitPath:'', getJtl:false, getJunit:false
            }
         }
    }
}
